...
The newer fast/SIMD parser is an attractive future optimization, but exposing it in v0.1 would expand the portability and testing matrix before the basic R semantics are proven.
